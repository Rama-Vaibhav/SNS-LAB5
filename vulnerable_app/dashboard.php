...
<head>
  ...
  <style>
    ...
    th { background: rgba(231,76,60,0.15); color: var(--accent); letter-spacing: .07em; }
    td { color: var(--text); }
    ...
    .attack-banner .banner-icon { font-size: 1.5em; }
    .attack-banner .banner-title { font-weight: bold; font-size: 1.05em; }
    .attack-banner .banner-body  { font-size: 1em; margin-top: 4px; }

    /* ── Per-attack colour themes ────────────────────────────────────── */
    .banner-auth    { color:#00695c; background:#e0f2f1; border-color:#26a69a; }
    .banner-union   { color:#0d47a1; background:#e3f2fd; border-color:#64b5f6; }
    .banner-blind-t { color:#6d4c41; background:#efebe9; border-color:#a1887f; }
    .banner-blind-f { color:#b71c1c; background:#ffebee; border-color:#ef9a9a; }
    .banner-dbmod   { color:#4a148c; background:#f3e5f5; border-color:#ab47bc; }
